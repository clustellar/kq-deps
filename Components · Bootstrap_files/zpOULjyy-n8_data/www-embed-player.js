...
return a}
var hc={Va:"allow-forms",Wa:"allow-modals",Xa:"allow-orientation-lock",Ya:"allow-pointer-lock",Za:"allow-popups",ab:"allow-popups-to-escape-sandbox",bb:"allow-presentation",cb:"allow-same-origin",eb:"allow-scripts",fb:"allow-top-navigation",gb:"allow-top-navigation-by-user-activation"},jc=Fb(function(){return ic()});
...
function Kc(a){var b=Ic();b.update(a);return b.qa().toLowerCase()}
...
b.ga&&0<b.timeout&&(f=T(function(){e||(e=!0,U(f),b.ga.call(b.context||q))},b.timeout))}else Ke(a,b)}
function Ke(a,b){var c=b.format||"JSON";a=Ie(a,b);var d=Je(a,b),e=!1,f,g=Le(a,function(a){if(!e){e=!0;f&&U(f);var d=xe(a),g=null,h=400<=a.status&&500>a.status,ea=500<=a.status&&600>a.status;if(d||h||ea)g=Me(c,a,b.lb);if(d)a:if(a&&204==a.status)d=!0;else{switch(c){case "XML":d=0==parseInt(g&&g.return_code,10);break a;case "RAW":d=!0;break a}d=!!g}g=g||{};h=b.context||q;d?b.onSuccess&&b.onSuccess.call(h,a,g):b.onError&&b.onError.call(h,a,g);b.ca&&b.ca.call(h,a,g)}},b.method,d,b.headers,b.responseType,
b.withCredentials);
b.L&&0<b.timeout&&(f=T(function(){e||(e=!0,g.abort(),U(f),b.L.call(b.context||q,g))},b.timeout));
return g}
function Ie(a,b){b.va&&(a=document.location.protocol+"//"+document.location.hostname+(document.location.port?":"+document.location.port:"")+a);var c=Q("XSRF_FIELD_NAME",void 0),d=b.Ua;d&&(d[c]&&delete d[c],a=Ae(a,d||{},!0));return a}
function Je(a,b){var c=Q("XSRF_FIELD_NAME",void 0),d=Q("XSRF_TOKEN",void 0),e=b.postBody||"",f=b.B,g=ke("XSRF_FIELD_NAME"),h;b.headers&&(h=b.headers["Content-Type"]);b.mb||I(J(3,a))&&!b.withCredentials&&I(J(3,a))!=document.location.hostname||"POST"!=b.method||h&&"application/x-www-form-urlencoded"!=h||b.B&&b.B[g]||(f||(f={}),f[c]=d);f&&t(e)&&(e=ze(e),kb(e,f),e=b.ha&&"JSON"==b.ha?JSON.stringify(e):pc(e));f=e||f&&!eb(f);!De&&f&&"POST"!=b.method&&(De=!0,R(Error("AJAX request with postData should use POST")));
return e}
...
We[a.message]||0<=e.indexOf("/YouTubeCenter.js")||0<=e.indexOf("/mytube.js")))){b={Ua:{a:"logerror",t:"jserror",type:a.name,msg:a.message.substr(0,250),line:d,level:b,"client.name":f.name},B:{url:Q("PAGE_NAME",window.location.href),file:a.fileName},method:"POST"};f.version&&(b["client.version"]=f.version);e&&(b.B.stack=e);for(var g in f)b.B["client."+g]=f[g];if(g=Q("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS",void 0))for(var h in g)b.B[h]=g[h];Ke(Q("ECATCHER_REPORT_HOST","")+"/error_204",b);We[a.message]=
!0;Xe++}}
...
function ag(a){var b=void 0===a?{}:a;a=void 0===b.wa?!0:b.wa;b=void 0===b.Ja?!1:b.Ja;if(null==w("_lact",window)){var c=parseInt(Q("LACT"),10);c=isFinite(c)?B()-Math.max(c,0):-1;v("_lact",c,window);v("_fact",c,window);-1==c&&bg();V(document,"keydown",bg);V(document,"keyup",bg);V(document,"mousedown",bg);V(document,"mouseup",bg);a&&(b?V(window,"touchmove",function(){cg("touchmove",200)},{passive:!0}):(V(window,"resize",function(){cg("resize",200)}),V(window,"scroll",function(){cg("scroll",200)})));
...
function qg(a,b){var c=hg[a],d=og[a]||{};og[a]=d;var e=Math.round(O());for(l in W[a]){var f=ib,g=b.b;g={client:{hl:g.Ca,gl:g.Ba,clientName:g.za,clientVersion:g.Aa}};var h=window.devicePixelRatio;h&&1!=h&&(g.client.screenDensityFloat=String(h));Q("DELEGATED_SESSION_ID")&&!S("pageid_as_header_web")&&(g.user={onBehalfOfUser:Q("DELEGATED_SESSION_ID")});f=f({context:g});f[c]=sg(a,l);d.dispatchedEventCount=d.dispatchedEventCount||0;d.dispatchedEventCount+=f[c].length;if(g=ng[l])a:{var m=l;if(g.videoId)h=
...
;function wg(a,b,c){c=void 0===c?{}:c;var d={"X-Goog-Visitor-Id":c.visitorData||Q("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.ib||Q("AUTHORIZATION"))||(a?b="Bearer "+w("gapi.auth.getToken")().hb:b=Lc([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=Q("SESSION_INDEX",0),S("pageid_as_header_web")&&(d["X-Goog-PageId"]=Q("DELEGATED_SESSION_ID")));return d}
...
;function Eg(a){var b=this;this.b=a||{xa:ke("INNERTUBE_API_KEY"),ya:ke("INNERTUBE_API_VERSION"),za:Q("INNERTUBE_CONTEXT_CLIENT_NAME","WEB"),Aa:ke("INNERTUBE_CONTEXT_CLIENT_VERSION"),Ca:ke("INNERTUBE_CONTEXT_HL"),Ba:ke("INNERTUBE_CONTEXT_GL"),Da:ke("INNERTUBE_HOST_OVERRIDE")||"",Ea:!!Q("INNERTUBE_USE_THIRD_PARTY_AUTH",!1)};Af(function(){Dg(b)},0,5E3)}
function tg(a,b,c,d){!Q("VISITOR_DATA")&&.01>Math.random()&&R(Error("Missing VISITOR_DATA when sending innertube request."),"WARNING");var e={headers:{"Content-Type":"application/json"},method:"POST",B:c,ha:"JSON",L:function(){d.L()},
...
timeout:d.timeout,withCredentials:!0},f="",g=a.b.Da;g&&(f=g);g=a.b.Ea||!1;var h=wg(g,f,d);Object.assign(e.headers,h);e.headers.Authorization&&!f&&(e.headers["x-origin"]=window.location.origin);var m=""+f+("/youtubei/"+a.b.ya+"/"+b)+"?alt=json&key="+a.b.xa,l;if(d.retry&&S("retry_web_logging_batches")&&"www.youtube-nocookie.com"!=f&&(l=Bg(b,c,h,g))){var u=e.onSuccess,ea=e.fa;e.onSuccess=function(a,b){Cg(l);u(a,b)};
c.fa=function(a,b){Cg(l);ea(a,b)}}try{S("use_fetch_for_op_xhr")?He(m,e):Qe(m,e)}catch(Dd){if("InvalidAccessError"==Dd)l&&(Cg(l),l=0),R(Error("An extension is blocking network request."),"WARNING");
...
vg("visualElementAttached",a,Eg,void 0,void 0)}
...
n(Wg,L);Wg.prototype.j=function(){for(;this.b.length;){var a=this.b.pop();a.target.removeEventListener(a.name,a.kb)}L.prototype.j.call(this)};var Xg=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;function Yg(a){a=a||"";if(window.spf){var b=a.match(Xg);spf.style.load(a,b?b[1]:"",void 0)}else Zg(a)}
...
;function bh(a,b){L.call(this);this.i=this.R=a;this.C=b;this.l=!1;this.api={};this.O=this.A=null;this.F=new N;cd(this,Da(dd,this.F));this.g={};this.M=this.P=this.f=this.W=this.b=null;this.G=!1;this.h=this.u=null;this.T={};this.la=["onReady"];this.V=null;this.da=NaN;this.N={};ch(this);this.U("WATCH_LATER_VIDEO_ADDED",this.Ga.bind(this));this.U("WATCH_LATER_VIDEO_REMOVED",this.Ha.bind(this));this.U("onAdAnnounce",this.oa.bind(this));this.ma=new Wg(this);cd(this,Da(dd,this.ma))}
n(bh,L);k=bh.prototype;
k.loadNewVideoConfig=function(a){if(!this.c){a instanceof Tg||(a=new Tg(a));this.W=a;this.b=a.clone();this.f=this.b.attrs.id||this.f;"video-player"==this.f&&(this.f=this.C,this.b.attrs.id=this.C);this.i.id==this.f&&(this.f+="-player",this.b.attrs.id=this.f);this.b.args.enablejsapi="1";this.b.args.playerapiid=this.C;this.P||(this.P=dh(this,this.b.args.jsapicallback||"onYouTubePlayerReady"));this.b.args.jsapicallback=null;if(a=this.b.attrs.width)this.i.style.width=lc(Number(a)||a);if(a=this.b.attrs.height)this.i.style.height=
lc(Number(a)||a);eh(this);this.l&&fh(this)}};
...
function ih(a){if(!a.c){var b=hh(a),c=!1;b&&b.getApiInterface&&b.getApiInterface()&&(c=!0);c?(a.G=!1,b.isNotServable&&b.isNotServable(a.b.args.video_id)||lh(a)):a.da=T(function(){ih(a)},50)}}
...
function ch(a){a.l=!1;if(a.O)for(var b in a.g)a.O(b,a.g[b]);for(var c in a.N)U(parseInt(c,10));a.N={};a.A=null;a.O=null;for(var d in a.api)a.api[d]=null;a.api.addEventListener=a.U.bind(a);a.api.removeEventListener=a.La.bind(a);a.api.destroy=a.dispose.bind(a);a.api.getLastError=a.ta.bind(a);a.api.getPlayerType=a.ua.bind(a);a.api.getCurrentVideoConfig=a.sa.bind(a);a.api.loadNewVideoConfig=a.loadNewVideoConfig.bind(a);a.api.isReady=a.Fa.bind(a)}
k.Fa=function(){return this.l};
k.U=function(a,b){var c=this,d=dh(this,b);if(d){if(!(0<=Ga(this.la,a)||this.g[a])){var e=nh(this,a);this.A&&this.A(a,e)}this.F.subscribe(a,d);"onReady"==a&&this.l&&T(function(){d(c.api)},0)}};
k.La=function(a,b){if(!this.c){var c=dh(this,b);c&&Qd(this.F,a,c)}};
...
fb(a.N,String(d))};
return c}
k.oa=function(a){mf("a11y-announce",a)};
k.Ga=function(a){mf("WATCH_LATER_VIDEO_ADDED",a)};
k.Ha=function(a){mf("WATCH_LATER_VIDEO_REMOVED",a)};
k.ua=function(){return this.M||(hh(this)?"html5":null)};
...
k.cancel=function(){this.u&&xf(this.b.assets.js,this.u);U(this.da);this.G=!1};
...
;var oh={},ph="player_uid_"+(1E9*Math.random()>>>0);function qh(a){var b="player";b=t(b)?Wb(b):b;var c=ph+"_"+(b[za]||(b[za]=++Aa)),d=oh[c];if(d)return d.loadNewVideoConfig(a),d.api;d=new bh(b,c);oh[c]=d;mf("player-added",d.api);cd(d,Da(rh,d));T(function(){d.loadNewVideoConfig(a)},0);
return d.api}
function rh(a){delete oh[a.C]}
;function sh(a,b,c){var d=Eg;Q("ytLoggingEventsDefaultDisabled",!1)&&Eg==Eg&&(d=null);vg(a,b,d,c,void 0)}
;var th=w("ytLoggingLatencyUsageStats_")||{};v("ytLoggingLatencyUsageStats_",th,void 0);var uh=0;function vh(a){th[a]=th[a]||{count:0};var b=th[a];b.count++;b.time=O();uh||(uh=Af(wh,0,5E3));if(10<b.count){if(11==b.count){b=0==a.indexOf("info")?"WARNING":"ERROR";var c=Error("CSI data exceeded logging limit with key");c.params=a;Ye(c,b)}return!0}return!1}
...
;function bi(a){L.call(this);this.f=a;this.f.subscribe("command",this.ia,this);this.g={};this.h=!1}
...
k.Na=function(a,b){this.h&&!this.c&&ci(this.f,a,this.Y(a,b))};
k.Y=function(a,b){if(null!=b)return{value:b}};
function di(a,b){b in a.g&&(a.removeEventListener(b,a.g[b]),delete a.g[b])}
k.j=function(){var a=this.f;a.c||Qd(a.b,"command",this.ia,this);this.f=null;for(var b in this.g)di(this,b);bi.w.j.call(this)};function gi(a,b){bi.call(this,b);this.b=a;this.start()}
...
n(ii,hi);function ji(){var a=this.c=new ii(!!Q("WIDGET_ID_ENFORCE")),b=A(this.Ka,this);a.h=b;a.i=null;this.c.channel="widget";if(a=Q("WIDGET_ID"))this.c.sessionId=a;this.g=[];this.i=!1;this.h={}}
k=ji.prototype;k.Ka=function(a,b,c){"addEventListener"==a&&b?(a=b[0],this.h[a]||"onReady"==a||(this.addEventListener(a,ki(this,a)),this.h[a]=!0)):this.ka(a,b,c)};
k.ka=function(){};
...
k.dispose=function(){this.c=null};function mi(a){ji.call(this);this.b=a;this.f=[];this.addEventListener("onReady",A(this.Ia,this));this.addEventListener("onVideoProgress",A(this.Ra,this));this.addEventListener("onVolumeChange",A(this.Sa,this));this.addEventListener("onApiChange",A(this.Ma,this));this.addEventListener("onPlaybackQualityChange",A(this.Oa,this));this.addEventListener("onPlaybackRateChange",A(this.Pa,this));this.addEventListener("onStateChange",A(this.Qa,this));this.addEventListener("onWebglSettingsChanged",A(this.Ta,
this))}
C(mi,ji);k=mi.prototype;k.ka=function(a,b,c){if(this.b.shouldUseNewAvailabilityCheck()?this.b.isExternalMethodAvailable(a,c):this.b[a]){b=b||[];if(0<b.length&&Yh(a)){var d=b;if(z(d[0])&&!x(d[0]))d=d[0];else{var e={};switch(a){case "loadVideoById":case "cueVideoById":e=$h.apply(window,d);break;case "loadVideoByUrl":case "cueVideoByUrl":e=Zh.apply(window,d);break;case "loadPlaylist":case "cuePlaylist":e=ai.apply(window,d)}d=e}b.length=1;b[0]=d}this.b.handleExternalCall(a,b,c);Yh(a)&&li(this,this.Z())}};
...
k.Oa=function(a){li(this,{playbackQuality:a})};
k.Pa=function(a){li(this,{playbackRate:a})};
...
k.Sa=function(){li(this,{muted:this.b.isMuted(),volume:this.b.getVolume()})};
k.Ra=function(a){a={currentTime:a,videoBytesLoaded:this.b.getVideoBytesLoaded(),videoLoadedFraction:this.b.getVideoLoadedFraction(),currentTimeLastUpdated_:B()/1E3,playbackRate:this.b.getPlaybackRate(),mediaReferenceTime:this.b.getMediaReferenceTime()};this.b.getProgressState&&(a.progressState=this.b.getProgressState());li(this,a)};
k.Ta=function(){var a={sphericalProperties:this.b.getSphericalProperties()};li(this,a)};
...
;function Di(a){if("1"!==bb(le(),"args","privembed")){a&&me();try{Ci().then(function(a){a=pe(a);a.bsq=Ei++;Qe("//www.youtube.com/ad_data_204",{va:!1,B:a,withCredentials:!0})},function(){}),T(Di,18E5)}catch(b){R(b)}}}
